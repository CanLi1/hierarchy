...
function generate_fullspace()
	...
	# m = Model(solver=PajaritoSolver(rel_gap=0.001, timeout=50000, mip_solver=CplexSolver(), cont_solver=MosekSolver()))
	# m = Model(solver=IpoptSolver())
	m = Model(solver=KnitroSolver(KTR_PARAM_MIP_MAXNODES=0, KTR_PARAM_MIP_MAXTIMECPU=5e4))
