...
#demand and price
# D = zeros(4,6,3)
# D[1:4, 1:6, 1] = baseD[1:4,  1:6] * 0.7
# D[1:4, 1:6, 2] = baseD[1:4,  1:6] 
# D[1:4, 1:6, 3] = baseD[1:4,  1:6] * 1.3
...
for gen1 in 1:3
  for gen2 in 1:3
    ...
    D[1:4, 3, temp_s] = baseD[1:4, 3] *  ratios[gen1]
    D[1:4, 5, temp_s] = baseD[1:4, 5] * ratios[gen2]
